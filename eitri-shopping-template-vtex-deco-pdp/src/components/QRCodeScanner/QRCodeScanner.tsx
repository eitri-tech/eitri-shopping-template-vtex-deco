...
type ScanResult = { type: 'deeplink' | 'ean'; value: string } | undefined
...
export default function QRCodeScanner() {
	...
	const scanQRCode = async (): Promise<ScanResult> => {
		try {
			...
			const sanitizedValue = String(scannedValue).trim()
