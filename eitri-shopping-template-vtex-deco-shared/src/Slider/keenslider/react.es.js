import { useRef as n, useCallback as t, useEffect as i } from 'react'
function e(n) {
...
function p(n) {
	...
	return { height: r(t.height, n.offsetHeight), width: r(t.width, n.offsetWidth) }
}
function v(n, t, i, e) {
	var r = n && n[t]
...
function m(n, t) {
	...
	if ('object' !== i || null === n || null === t) return 'function' === i && n.toString() === t.toString()
	if (n.length !== t.length || Object.getOwnPropertyNames(n).length !== Object.getOwnPropertyNames(t).length)
		return !1
	for (var e in n) if (!m(n[e], t[e])) return !1
	return !0
}
var g = function () {
	return (
			...
			if ((l(), n.track.details)) {
				...
				;(i = 0),
					...
					(r = t.map(function (n) {
						...
						o += c
						var s = e
						return (e += r), (a += c), [i, n.distance, s, e, n.duration, u]
					})),
					s(n.track.distToIdx(a)),
					d(),
...
function x(n) {
	...
	function z(n) {
		var t = Math.floor(Math.abs(h(n / i))),
			e = h(((n % i) + i) % i)
		e === i && (e = 0)
		var r = f(n),
			a = c.indexOf(
				b([], c, !0).reduce(function (n, t) {
					return Math.abs(t - e) < Math.abs(n - e) ? t : n
				})
			),
			o = a
		return r < 0 && t++, a === u && ((o = 0), (t += r > 0 ? 1 : -1)), { abs: o + t * u * r, origin: a, rel: o }
	}
	function I(n, t, i) {
		var e
		if (t || !L()) return A(n, i)
		...
		e = A(c)
		var s = A(c - u * f(o))
		return ((null !== s && Math.abs(s) < Math.abs(e)) || null === e) && (e = s), h(e)
	}
	function A(n, t) {
		if ((null == t && (t = h(T)), !D(n) || null === n)) return null
		n = Math.round(n)
		var e = z(t),
			r = e.abs,
			a = e.rel,
	...
	function P(t) {
		var i
		;(i = t - T), w.push({ distance: i, timestamp: a() }), w.length > 6 && (w = w.slice(-6)), (T = h(t))
		var e = _().abs
		if (e !== M) {
			var r = null !== M
			;(M = e), r && n.emit('slideChanged')
		}
	}
	function _(a) {
		var c = a
					...
					if (u) {
						var n = L(),
							...
							k = o.map(function (t, e) {
								var a = c + s
								;(a < 0 - t[0] || a > 1) && (a += (Math.abs(a) > i - 1 && n ? i : 0) * f(-a))
								var o = e - h,
									d = f(o),
									l = o + v
								n &&
								...
								return (
									(s += t[0] + t[1]),
									{ abs: l, distance: r.rtl ? -1 * a + 1 - t[0] : a, portion: y, size: t[0] }
								)
							})
						return (
							(v = O(v)),
		...
		init: function (t) {
			if (
				((function () {
					if (
						...
						var t,
							a = u - 1
						;(e = h(i + o[0][2] - o[a][0] - o[a][2] - o[a][1])),
							(c = o.reduce(function (n, i) {
								if (!n) return [0]
								var e = o[n.length - 1],
			...
			!(function () {
				var t = n.options.range,
					i = n.options.loop
				;(m = d = i ? v(i, 'min', -1 / 0) : 0), (g = p = i ? v(i, 'max', k) : s)
				var e = v(t, 'min', null),
					r = v(t, 'max', null)
				null !== e && (d = e),
					null !== r && (p = r),
					(y = d === -1 / 0 ? d : n.track.idxToDist(d || 0, !0, 0)),
					(x = p === k ? p : I(p, !0, 0)),
					null === r && (g = p),
					v(t, 'align', !1) && p !== k && 0 === o[S(p)][2] && ((x -= 1 - o[S(p)][0]), (p = E(x - T))),
					(y = h(y)),
					(x = h(x))
			})(),
				(a = t),
				Number(a) === a ? C(A(O(t))) : _()
		},
		to: P,
		velocity: function () {
			var n = a(),
	...
	function h() {
		...
		if (e || !t) {
			var l = m(e),
				...
				g = l.dur
			if (((g = s(g)), (h *= r), t)) {
				var y = i.idxToDist(i.distToIdx(h), !0)
				y && (h = y)
			}
			c.push({ distance: h, duration: g, easing: p })
			var x = u.position,
				k = x + h
			if (k < a || k > o) {
				var w = k < a ? a - x : o - x,
				...
				if (f(w) === r) {
					...
					;(c[0].earlyExit = E), (T = e * (1 - C))
				} else (c[0].earlyExit = 0), (M += w)
				var z = m(T, 100),
					I = z.dist * r
				n.options.rubberband &&
					(c.push({ distance: I, duration: s(z.dur), easing: p }),
					c.push({ distance: -I + M, duration: 500, easing: p }))
			}
			n.animator.start(c)
		} else
			n.moveToIdx(d(u.abs), !0, {
				duration: 500,
				easing: function (n) {
					return 1 + --n * n * n * n * n
				}
		...
		n.on('dragEnded', function () {
			...
			'snap' === e &&
				(function () {
					...
					;(u > o || u < a) && (c = 0)
					var s = t + c
					0 === r.slides[e.absToRel(s)].portion && (s -= c),
						t !== i && (s = i),
						f(e.idxToDist(s, !0)) !== c && (s += c),
						(s = d(s))
					var l = e.idxToDist(s, !0)
					n.animator.start([
						{
							distance: l,
							duration: 500,
...
function w(n) {
		...
		if (o && v === t.id) {
			...
			var d = (function (t) {
				...
				var e = n.track.details,
					...
					c = l(t, M - u, T - u)
				if (0 === o) return 0
				if (!n.options.rubberband) return c
				if (u <= T && u >= M) return t
	...
	function z(t) {
		!o &&
			...
			((g = 0), (o = !0), (b = !1), (h = !0), (v = t.id), A(t), (m = D(t)), n.emit('dragStarted'))
	}
	function I(t) {
		o && v === t.idChanged && ((o = !1), n.emit('dragEnded'))
	}
	function A(n) {
		var t = O(),
			i = t ? n.y : n.x,
			e = t ? n.x : n.y,
			r = void 0 !== y && void 0 !== x && Math.abs(x - e) <= Math.abs(y - i)
		return (y = i), (x = e), r
	}
	function D(n) {
		return O() ? n.y : n.x
		...
		if ((C.purge(), n.options.drag && !n.options.disabled)) {
			...
			;(i = n.options.dragSpeed || 1),
				...
				(function () {
					...
					u('['.concat(n, ']:not([').concat(n, '=false])'), t).map(function (n) {
			...
			u('['.concat(r, ']:not([').concat(r, '=false])'), n.container).map(function (n) {
				return (function (n) {
					var t
					C.input(
						n,
						...
						C.input(n, 'touchmove', function (i) {
							var e = O(),
								...
								u = (e && 'scroll' === n.style.overflowY) || (!e && 'scroll' === n.style.overflowX)
							if (((t = D(i)), ((a < 0 && o > 0) || (a > 0 && o < r)) && k && u)) return (w = !0)
							;(k = !1), c(i), (w = !1)
						}),
	...
	n.on('updated', L), n.on('optionsChanged', P), n.on('created', P), n.on('destroyed', C.purge)
}
function M(n) {
	var t,
		i,
	...
	function o(i, r, a) {
		...
		if (d && t) {
			...
			t.forEach(function (n, t) {
				if (i) !e && r && c(n, null, a), s(n, null, a)
				else {
					if (!l[t]) return
					var d = l[t].size * u
					!e && r && c(n, d, a), s(n, l[t].distance * u - o, a), (o += d)
				}
			})
		}
	}
	...
	function f() {
		d(),
			...
			n.options.disabled ||
				...
				((e = 'auto' === v(n.options.slides, 'perView', null)),
	...
	return function (i) {
		...
		function h(n) {
			...
			o(
				i.container,
				'reverse',
				'rtl' !== ((t = i.container), window.getComputedStyle(t, null).getPropertyValue('direction')) || n
					? null
					: ''
			),
				o(i.container, 'v', i.options.vertical && !n ? '' : null),
				o(i.container, 'disabled', i.options.disabled && !n ? '' : null)
		}
		function m() {
			b() && M()
		}
		function b() {
			...
			if (
				...
				return !1
			e || i.emit('beforeOptionsChanged'), (e = n)
			var t = n ? a.breakpoints[n] : a
			return (i.options = g(g({}, a), t)), h(), I(), A(), C(), !0
		}
		function y(n) {
			var t = p(n)
			return (i.options.vertical ? t.height : t.width) / i.size || 1
		}
		function x() {
			return i.options.trackConfig.length
		}
		function k(n) {
			for (var o in ((e = !1), (a = g(g({}, t), n)), f.purge(), (r = i.size), (c = []), a.breakpoints || [])) {
				var u = window.matchMedia(o)
				;(u.__media = o), c.push(u), f.add(u, 'change', m)
			}
			f.add(window, 'orientationchange', z), f.add(window, 'resize', E), b()
		}
		function w(n) {
			i.animator.stop()
			var t = i.track.details
			i.track.init(null != n ? n : t ? t.abs : 0)
		}
		function M(n) {
			w(n), i.emit('optionsChanged')
		}
		function T(n, t) {
			if (n) return k(n), void M(t)
			I(), A()
			var e = x()
			C(), x() !== e ? M(t) : w(t), i.emit('updated')
		}
		function C() {
			var n = i.options.slides
			if ('function' == typeof n) return (i.options.trackConfig = n(i.size, i.slides))
			for (
				var t = i.slides,
					e = t.length,
					r = 'number' == typeof n ? n : v(n, 'number', e, !0),
					a = [],
					o = v(n, 'perView', 1, !0),
					u = v(n, 'spacing', 0, !0) / i.size || 0,
					c = 'auto' === o ? u : u / o,
					s = v(n, 'origin', 'auto'),
					d = 0,
					l = 0;
				...
				var f = 'auto' === o ? y(t[l]) : 1 / o - u + c,
					p = 'center' === s ? 0.5 - f / 2 : 'auto' === s ? 0 : s
				a.push({ origin: p, size: f, spacing: u }), (d += f)
			}
			if (((d += u * (r - 1)), 'auto' === s && !i.options.loop && 1 !== o)) {
				var h = 0
				a.map(function (n) {
					var t = d - h
			...
			i.options.trackConfig = a
		}
		function E() {
			I()
			var n = i.size
			i.options.disabled || n === r || ((r = n), T())
		}
		function z() {
		...
		function I() {
			var n = p(i.container)
			i.size = (i.options.vertical ? n.height : n.width) || 1
		}
		function A() {
			i.slides = u(i.options.selector, i.container)
		}
		;(i.container = (l = u(n, s || document)).length ? l[0] : null),
			(i.destroy = function () {
				f.purge(), i.emit('destroyed'), h(!0)
			}),
			(i.prev = function () {
	...
	try {
		return (function (n, t) {
			...
			return (
					...
					moveToIdx: function (n, t, e) {
						...
						if (r) {
							...
							i.animator.start([
								{
									distance: r,
									duration: v(e || a, 'duration', 500),
									easing: v(e || a, 'easing', function (n) {
										return 1 + --n * n * n * n * n
									})
								}
							])
				...
				(function () {
					if (((i.track = x(i)), (i.animator = y(i)), t))
...
function E(e, r) {
	var a = n(null),
		...
		c = t(function (n) {
			n
				? ((u.current = e), (a.current = new C(n, e, r)), (o.current = !1))
				: (a.current && a.current.destroy && a.current.destroy(), (a.current = null))
		}, [])
	return (
		i(
			function () {
				m(u.current, e) || ((u.current = e), a.current && a.current.update(u.current))
			},
			[e]
		),
		[c, a]
