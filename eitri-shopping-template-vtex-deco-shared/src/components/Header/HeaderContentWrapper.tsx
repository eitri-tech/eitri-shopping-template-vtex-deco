...
interface HeaderContentWrapperProps {
	...
	scrollEffectMaxTranslate?: string
	...
	hideAfterViewportHeights?: number
	height?: number
	className?: string
...
export default function HeaderContentWrapper(props: HeaderContentWrapperProps) {
	const {
		children,
		scrollEffect,
	...
	const safeAreaTopRef = useRef(safeAreaTop)
