...
import type { OrderingValue } from '../../../utils/lists'
...
export default function CatalogSort({ currentSort, onSortChange, hiddenSortOptions = [] }: Props) {
	...
	const isCurrentSort = (sortOption: OrderingValue) => {
