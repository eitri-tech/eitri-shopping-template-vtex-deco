...
// preserves the existing password-visibility toggle behavior instead of silently dropping it.
...
export default function CustomInput(props: CustomInputProps) {
	...
	const handleFocus = (e: FocusEvent<HTMLInputElement>) => {
		Eitri.keyboard.setVisibilityListener((status: { code: string }) => {
	...
	return (
		<View className='w-full'>
			...
			<View className='relative'>
				<TextInputAny
					className={`w-full border-gray-300 border-solid border-2 bg-white focus:outline-none rounded-none ${className}`}
