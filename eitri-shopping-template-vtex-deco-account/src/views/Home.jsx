...
export default function Home(props) {
	...
	const init = async ({ isAppOpen = false } = {}) => {
	...
	const loadBonusBalance = async customerData => {
		try {
			const { balance } = await loadBonusScreenData(customerData)
	...
	const isPermissionGranted = permission => permission?.status === 'GRANTED' || permission?.status === 'LIMITED'
