...
import { Text, TextInput, View } from 'eitri-luminus'
...
// applied in shared's CustomInput.tsx to preserve this input's real `type='text'` usage.
...
export default function SearchInput(props: SearchInputProps) {
	...
	// Vtex.configs is typed as an empty object in the generated stub for eitri-shopping-vtex-shared
	// (see the eitri-typescript-migrate skill's "shared-library @types cache trap") — cast narrowly
	// to the one field this component actually reads.
