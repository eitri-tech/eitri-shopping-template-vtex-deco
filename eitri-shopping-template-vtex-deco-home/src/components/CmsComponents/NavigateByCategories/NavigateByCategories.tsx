...
interface NavigateByCategoriesData {
	title?: string
	items?: NavItem[]
}

interface NavigateByCategoriesProps {
	data?: NavigateByCategoriesData
}

export default function NavigateByCategories(props: NavigateByCategoriesProps) {
	const { data } = props
