...
const AUTO_SIZE_MAP: Record<string, number> = {
	'three-one-half': 3.5,
	'four-three-four': 4.5,
	five: 5
}
...
export default function BannerList(props: BannerListProps) {
	...
	const getBannerDimensions = (): { width: string; height: string } => {
		if (autoSize && AUTO_SIZE_MAP[autoSize]) {
			const divisor = AUTO_SIZE_MAP[autoSize]
